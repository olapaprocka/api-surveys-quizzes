...
import pl.paprocka.apisurveysquizzes.config.Roles;

import java.util.Arrays;

import static pl.paprocka.apisurveysquizzes.config.Roles.ADMIN;
import static pl.paprocka.apisurveysquizzes.config.Roles.USER;
